...
export const RestoScreen = ({ route, navigation }: Props) => {
  ...
  const [crenModalVisible, setCrenModalVisible] = useState(
    route.params.day === "null" || route.params.day !== undefined
  );
    ...
    return (
      ...
      >
        <Text
          style={[
            styles.dateText,
            { color: textColor, fontFamily: "geometria-regular" },
          ]}
        >
            ...
            <TouchableOpacity
              onPress={() => {
                ...
                navigation.navigate(goto, {
                  ...
                  bookingType: bookingType,
                  day: moment
                    .tz(selectedDay, "YYYY-MM-DD", "America/Martinique")
                    .format(),
                  hour: selectedHour,
                });
              }}
            ...
            {myintcust.preswebsite && (
              <View style={styles.wrapperHTML}>
                <HTML
                  ...
                  source={{ html: myintcust.preswebsite || "<p>a</p> " }}
                />
              </View>
            )}
                            ...
                            return (
                              <View key={cat.id + menu.id}>
                                <ListItem
                                  ...
                                  onPress={() => {
                                    Alert.alert(
                                      "Merci de choisir un mode ci-dessous."
                                    );
                                  }}
                                  bottomDivider
                                  containerStyle={{
                                ...
                                >
                                  <ListItem.Content>
                                    ...
                                    {((menu.minPricevar && menu.minPricevar > 0) || menu.price > 0) && 
                                      <ListItem.Subtitle
                                        style={{
                                          marginTop: 2,
                                          color: textColor,
                                      ...
                                      >
                                        {(menu.minPricevar && menu.minPricevar > 0) ? `À partir de ${menu.minPricevar}` : menu.price} €
                                      </ListItem.Subtitle>
                                    }
                                  </ListItem.Content>
                                  {menu && menu.imageUrl !== "" && (
