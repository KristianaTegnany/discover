...
export const RestoScreen = ({ route, navigation }: Props) => {
  ...
  let businessHoursTakeAway = sortBy(myintcustRaw.businessHoursTakeAway, ['daysOfWeek']);
  ...
  let businessHoursDelivery = sortBy(myintcustRaw.businessHoursDelivery, ['daysOfWeek']);
