...
export const GuideScreen = ({ route, navigation }: Props) => {
  ...
  const tagsStyles = {
    ...
    h2: { fontFamily: "geometria-bold", fontSize: 24, color: textColor, marginVertical: 10 },
    h1: { fontFamily: "geometria-bold", fontSize: 24, color: textColor, marginVertical: 10 },
    h3: { fontFamily: "geometria-bold", fontSize: 24, color: textColor, marginVertical: 10 },
