  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        ...
        <Text style={styles.text}>
          Fin de commande le midi :{myintcust.takeawaynightblock}{" "}
        </Text>
        ...
        <Text style={styles.text}>
          ...
          sélectionnée, jusqu'au début du créneau suivant.{" "}
        </Text>
        <Text style={styles.text}>Les livraisons sont assurées par : </Text>
        <Text style={styles.text}>
          Nos prestataires mettent tout en oeuvre pour tenir le délai du
          créneau.{" "}
        </Text>
        <Text style={styles.text}>
        ...
        <Text style={styles.text}>
          En cas de retard de livraison, ne relevant pas de ces cas, il est à la
          discrétion du restaurant et/ou du livreur de vous proposer une
          compensation. Le contenu de cette compensation est à sa libre
          définition.{" "}
        </Text>
        <Text style={styles.text}>
          Pour compléter une commande, merci d'effectuer une nouvelle commande
          et d'indiquer une demande de regroupement en note de livraison. Les
          frais de livraison de la deuxième commande vous seront remboursés à
          postériori.{" "}
        </Text>

        <Text style={styles.text}>
          Merci de respecter les gestes barrières et les consignes sanitaires,
          notamment de porter un masque et de mettre du gel avant et après avoir
          récupéré votre commande A emporter ou En livraison.{" "}
        </Text>
      </ScrollView>
    </View>
  );
